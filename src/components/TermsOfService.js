...
function TermsOfService() {
  return (
    <div className="terms-of-service">
      ...
      <p>Last updated: 27.09.2024</p>
      <p>By accessing or using Grounded Affirmations (the "Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of the terms, you may not access the Service.</p>
      ...
      <h3>4.1. Ownership</h3>
      <p>You retain ownership of the content you create and post on the Service.</p>
